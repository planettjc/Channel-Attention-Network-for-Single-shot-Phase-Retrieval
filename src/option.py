...
parser.add_argument('--data_train', type=str, default='Phase',
...
parser.add_argument('--inten_range', type=int, default=65535,
                    help='maximum value of grayscale input')
...
parser.add_argument('--save_gt', action='store_true',
                    help='save input and ground truth images together')
